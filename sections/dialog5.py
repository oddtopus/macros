...
class profEdit(QDialog):
  def __init__(self):
    ...
    self.scrollAreaWidgetContents = QScrollArea(self)#QWidget()
    #self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 156, 272))
    self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
    # self.gridLayout_5 = QGridLayout(self.scrollAreaWidgetContents)
    self.gridLayout_3 = QGridLayout(self.scrollAreaWidgetContents)
    self.gridLayout_3.setObjectName("gridLayout_3")
    self.tbH = QToolButton(self.scrollAreaWidgetContents)
    ...
    self.tbZ = QToolButton(self.scrollAreaWidgetContents)
    ...
    self.tbCircle = QToolButton(self.scrollAreaWidgetContents)    #TO DELETE
    ...
    self.tbOmega = QToolButton(self.scrollAreaWidgetContents)     #TODO
    ...
    icon = QIcon()
    icon.addPixmap(pixOmega, QIcon.Normal, QIcon.Off)
    self.tbOmega.setIcon(icon)
    self.tbOmega.setObjectName("tbOmega")
    self.gridLayout_3.addWidget(self.tbOmega, 4, 1, 1, 1)
    ####
    # self.tbTest1 = QToolButton(self.scrollAreaWidgetContents)     #TODO
    # self.tbTest1.setSizePolicy(sizePolicy)
    # self.tbTest1.setMinimumSize(QSize(56, 56))
    # self.tbTest1.setBaseSize(QSize(56, 56))
    # self.tbTest1.setIconSize(QSize(48, 48))
    # self.tbTest1.setObjectName("tbTest1")
    # self.gridLayout_3.addWidget(self.tbTest1, 5, 0, 1, 1)
    # self.tbTest2 = QToolButton(self.scrollAreaWidgetContents)     #TODO
    # self.tbTest2.setSizePolicy(sizePolicy)
    # self.tbTest2.setMinimumSize(QSize(56, 56))
    # self.tbTest2.setBaseSize(QSize(56, 56))
    # self.tbTest2.setIconSize(QSize(48, 48))
    # self.tbTest2.setObjectName("tbTest2")
    # self.gridLayout_3.addWidget(self.tbTest2, 5, 1, 1, 1)
    ####
    self.tbT = QToolButton(self.scrollAreaWidgetContents)
    ...
    self.tbL = QToolButton(self.scrollAreaWidgetContents)
    ...
    self.gridLayout_4.addWidget(self.scrollAreaWidgetContents, 0, 0, 5, 1)
  ...
  def setProfile(self, typeS):
    if typeS=='square':
      ...
      self.labImg.setPixmap(pixOmega)
      self.type="omega"
  ...
  def draw(self):
    ...
    if FreeCAD.ActiveDocument:
      if self.type=='RH'and t2<H/2 and t1<B/2:
        ...
        customArchProfile.doProfile(self.type,label,[B,H,D,t1,t2,t3])
